...
const BookmarkPage = (props) => {
    ...
    const onSubmitBookmark = async (obj) => {
        ...
        let finalObj = {
            ...
            metaData: {
                ...
                isYoutube: obj.assetUrl.includes("youtube.com"),
    ...
    return (
        <OperationLayout 
            ...
            pageTitle={currentGem ? "Update bookmark" : "Add new bookmark"}
        ...
        >
            ...
            <div className="gradient-add-bookmark-div">
                  <img src={(currentGem?.metaData?.covers && currentGem?.metaData?.covers?.length>0) ? currentGem?.metaData?.covers[0] : `${process.env.REACT_APP_STATIC_IMAGES_CDN}/webapp/curateit-logo.png`}
